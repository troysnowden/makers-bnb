...
class AccommodationAccess
  class << self
    ...
    def all_available_within_max_price_on_date(max_price, chosen_date)
      ...
      result = DatabaseConnection.connect_to_db.exec_params("SELECT * from accommodations;") # change this to accommodate above requirement
    ...
    def create(user, accommodation)
      ...
      DatabaseConnection.connect_to_db.exec_params("INSERT INTO accommodations(owner_id, name, description, price_per_night) VALUES ($1, $2, $3, $4);", 
